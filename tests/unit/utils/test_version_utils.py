...
with patch.dict('sys.modules', {
    ...
    try:
        from cli.utils.version_utils import VersionComparator, ComponentVersionManager
    except ImportError:
...
class TestVersionComparator:
    ...
    def test_parse_version_invalid(self):
        ...
        with patch('cli.utils.version_utils.SemanticVersion', side_effect=Exception("Invalid version")):
...
class TestComponentVersionManager:
    ...
    def test_error_handling(self, version_manager):
        ...
        if hasattr(version_manager, 'version_manager'):
            version_manager.version_manager.get_current_version.side_effect = Exception("Version error")
...
class TestPerformance:
    ...
    def test_version_parsing_performance(self):
        ...
        versions = [f"1.{i}.{j}" for i in range(100) for j in range(10)]
