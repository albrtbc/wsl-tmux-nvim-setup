...
from cli.wsm import cli, WSMContext, show_welcome_screen, main
...
class TestCLICommands:
    ...
    def test_cli_custom_config_dir(self, cli_runner, temp_config_dir, mock_config_manager):
        ...
        with patch('cli.wsm.ConfigManager', return_value=mock_config_manager), \
             patch('cli.wsm.show_welcome_screen') as mock_welcome:
...
class TestWelcomeScreen:
    ...
    def test_show_welcome_screen_error_handling(self, mock_console):
        ...
        with patch('cli.wsm.get_default_config_manager', side_effect=Exception("Config error")), \
             patch('cli.wsm.Console', return_value=mock_console):
...
class TestDoctorCommand:
    ...
    def test_doctor_command_wsl_detection(self, cli_runner, mock_config_manager, mock_version_manager):
    ...
    def test_doctor_command_dependency_check(self, cli_runner, mock_config_manager, mock_version_manager):
    ...
    def test_doctor_command_recommendations(self, cli_runner, mock_config_manager, mock_version_manager):
...
class TestVersionInfoCommand:
    ...
    def test_version_info_with_components(self, cli_runner, mock_config_manager, mock_version_manager):
    ...
    def test_version_info_with_compatibility(self, cli_runner, mock_config_manager, mock_version_manager):
    ...
    def test_version_info_error_handling(self, cli_runner, mock_config_manager):
        ...
        with patch('cli.wsm.get_default_config_manager', return_value=mock_config_manager), \
             patch('cli.wsm.ComponentVersionManager', side_effect=Exception("Version error")):
...
class TestMainFunction:
    ...
    def test_main_success(self, mock_config_manager):
        ...
        with patch('cli.wsm.cli') as mock_cli, \
             patch('cli.wsm.get_default_config_manager', return_value=mock_config_manager):
    ...
    def test_main_keyboard_interrupt(self, mock_console):
        ...
        with patch('cli.wsm.cli', side_effect=KeyboardInterrupt), \
             patch('cli.wsm.Console', return_value=mock_console):
    ...
    def test_main_unexpected_error(self, mock_console):
        ...
        with patch('cli.wsm.cli', side_effect=test_error), \
             patch('cli.wsm.Console', return_value=mock_console), \
    ...
    def test_main_debug_mode(self, mock_console):
        ...
        with patch('cli.wsm.cli', side_effect=test_error), \
             patch('cli.wsm.Console', return_value=mock_console), \
             patch.dict('os.environ', {'WSM_DEBUG': '1'}), \
