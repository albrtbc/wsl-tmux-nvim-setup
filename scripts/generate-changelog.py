...
class GitCommitParser:
    ...
    def parse_commits_to_entries(self, commits: List[Dict]) -> Dict[ChangeType, List[ChangeEntry]]:
        ...
        for commit in commits:
            ...
            if any(re.search(pattern, commit['subject'], re.IGNORECASE) 
...
class ChangelogGenerator:
    ...
    def generate_release_entry(self, version: str, changes: Dict[ChangeType, List[ChangeEntry]], 
                             is_unreleased: bool = False) -> str:
...
"""
    ...
    def generate_from_commits(self, since: str = None, mode: str = "unreleased") -> None:
        ...
        non_empty_changes = {
            change_type: entries for change_type, entries in changes.items()
            if entries
        }
