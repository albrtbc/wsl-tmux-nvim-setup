...
class GitHubReleaseClient:
    ...
    def upload_asset(self, release_id: int, asset: ReleaseAsset, 
...
class ReleaseUploader:
    ...
    def create_or_update_release(self, client: GitHubReleaseClient, 
                                version: str, prerelease: bool = False,
    ...
    def upload_assets_to_release(self, client: GitHubReleaseClient,
                                release_id: int, assets: List[ReleaseAsset],
                                replace_existing: bool = True) -> List[Dict]:
    ...
    def verify_assets(self, assets: List[ReleaseAsset], 
                     checksums_file: Optional[Path] = None) -> bool:
...
Environment Variables:
  GITHUB_TOKEN or GH_TOKEN    GitHub personal access token
    ...
    parser.add_argument('--assets-dir', '-a',
                        help='Assets directory (default: ./release-assets)')
    parser.add_argument('--repository', '-r',
                        help='GitHub repository (owner/repo, default: auto-detect)')
    parser.add_argument('--token', '-t',
                        help='GitHub token (default: from environment)')
    ...
    parser.add_argument('--no-verify',
                        action='store_true',
                        help='Skip asset verification')
    parser.add_argument('--replace-assets',
                        action='store_true',
