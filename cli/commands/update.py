...
class UpdateManager:
    ...
    def check_for_updates(self, include_prerelease: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                update_type = VersionComparator.get_update_type(current_sem, latest_sem) if is_newer else None
                breaking_change = VersionComparator.check_breaking_change(current_sem, latest_sem) if is_newer else False
    ...
    def perform_update(self, include_prerelease: bool = False, 
                      force: bool = False, skip_backup: bool = False) -> bool:
        """
    ...
    def show_update_summary(self, update_info: Dict[str, Any]) -> None:
        ...
        if update_info['update_available']:
            ...
            self.console.print(f"[yellow]💡 Update available: {current} → {latest} ({update_type})[/yellow]")
