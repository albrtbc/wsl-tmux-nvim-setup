...
class ConfigCommand:
        ...
        if format == "table":
            ...
            for key, value in config_dict.items():
                ...
                if isinstance(value, bool):
                    display_value = (
                        f"[green]{display_value}[/green]"
                        if value
                        else f"[red]{display_value}[/red]"
                    )
    ...
    def set_config_value(self, key: str, value: str) -> None:
        ...
        try:
            if field_type == bool:
                ...
                elif value.lower() in ["false", "0", "no", "of"]:
                ...
                if key == "update_frequency" and converted_value not in [
                    "daily",
                    "weekly",
                    "monthly",
                    "never",
                    ...
                    raise ValueError(
                        "update_frequency must be one of: daily, weekly, monthly, never"
                    )
        ...
        for category, settings in categories.items():
            ...
            for setting in settings:
                ...
                if field_info["type"] == bool:
                    ...
                    prompt_text = "New value (press Enter to keep current)"
    ...
    def reset_config(self) -> None:
        ...
        if Confirm.ask(
            "Reset all configuration to defaults? This cannot be undone.", default=False
        ):
            try:
