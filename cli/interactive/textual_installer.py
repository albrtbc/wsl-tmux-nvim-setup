...
try:
    ...
    from textual.widgets import (
        Header, Footer, Button, Checkbox, Label, Input, 
        ProgressBar, Tree, DataTable, TabPane, TabbedContent,
        Static, ListView, ListItem, SelectionList, Placeholder
    )
            ...
            with Container():
                ...
                with Vertical():
                    ...
                    for name, comp in self.components.items():
                        size_info = f" (~{comp.get('size_mb', 5):.0f}MB)" if comp.get('size_mb') else ""
            ...
            with Container():
                ...
                with ScrollableContainer():
                    ...
                    with Vertical():
                        ...
                        yield Input(value=default_path, placeholder="Installation directory", id="install_path")
    ...
    class InstallationProgressScreen(Screen):
        ...
        async def install_components(self) -> None:
            ...
            try:
                ...
                await log_list.append(ListItem(Label(f"✗ Installation failed: {e}", classes="error")))
