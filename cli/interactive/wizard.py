...
class InteractiveWizard:
    ...
    def _show_welcome_screen(self):
        ...
        panel = Panel(welcome_text, title="🚀 Installation Wizard", border_style="blue")
    ...
    def _rich_get_configuration(self) -> Dict[str, Any]:
        ...
        config["backup_enabled"] = Confirm.ask(
            "Enable automatic backups before updates?", default=True
        )
        ...
        config["parallel_downloads"] = Confirm.ask(
            "Enable parallel downloads for faster installation?", default=True
        )
        config["verify_checksums"] = Confirm.ask(
            "Verify file checksums for security?", default=True
        )
