...
class EnhancedLogger:
    ...
    def __init__(
        self, name: str = "wsm", log_dir: Optional[Path] = None, console: Optional[Console] = None
    ):
        self.name = name
    ...
    def _setup_logging(self):
        ...
        rich_handler = RichHandler(
            console=self.console, show_time=False, show_path=False, rich_tracebacks=True
        )
    ...
    def _display_error_panel(self, error_context: ErrorContext):
        ...
        error_text = Text()
        error_text.append("Error Category: ", style="bold")
        ...
        panel = Panel(error_text, title="🚨 Error Occurred", border_style="red")
