...
class DownloadManager:
    ...
    def __init__(self, timeout: int = 30, max_retries: int = 3, 
                 ...
                 cache_enabled: bool = True, offline_mode: bool = False):
    ...
    def download_file(self, url: str, output_path: Path, 
        ...
        if resume and output_path.exists():
            ...
            if self.show_progress:
                self.console.print(f"[yellow]Resuming download from byte {resume_byte_pos}[/yellow]")
        ...
        try:
                    ...
                    for chunk in response.iter_content(chunk_size=self.chunk_size):
                        if chunk:  # Filter out keep-alive chunks
                            ...
                            if progress_callback:
                                progress_callback(downloaded, total_size + resume_byte_pos if total_size else None)
            ...
            if expected_hash and hash_obj:
                ...
                if self.show_progress:
                    self.console.print(f"[green]✓ Hash verification passed[/green]")
    ...
    def download_multiple(self, downloads: Dict[str, Dict[str, Any]], 
                         max_concurrent: int = 4) -> Dict[str, Path]:
        """
    ...
    def verify_file_hash(self, file_path: Path, expected_hash: str, 
