...
class VersionComparator:
    ...
    @staticmethod
    def is_newer_version(current: Union[str, SemanticVersion], 
                        candidate: Union[str, SemanticVersion]) -> bool:
        """
    ...
    @staticmethod
    def is_compatible_version(version: Union[str, SemanticVersion],
                            min_version: Union[str, SemanticVersion],
                            max_version: Optional[Union[str, SemanticVersion]] = None) -> bool:
        """
    ...
    @staticmethod
    def filter_prereleases(versions: List[Union[str, SemanticVersion]], 
                          include_prereleases: bool = False) -> List[SemanticVersion]:
        """
    ...
    @staticmethod
    def get_latest_version(versions: List[Union[str, SemanticVersion]],
                          include_prereleases: bool = False) -> Optional[SemanticVersion]:
        """
    ...
    @staticmethod
    def check_breaking_change(old_version: Union[str, SemanticVersion],
                            new_version: Union[str, SemanticVersion]) -> bool:
        """
    ...
    @staticmethod
    def get_update_type(old_version: Union[str, SemanticVersion],
                       new_version: Union[str, SemanticVersion]) -> str:
        """
...
class ComponentVersionManager:
    ...
    def check_component_updates(self, available_versions: Dict[str, List[str]]) -> Dict[str, Dict[str, Any]]:
        """
        ...
        for component, current_version in current_versions.items():
            ...
            try:
                ...
                update_type = VersionComparator.get_update_type(current_sem, latest) if update_available else None
                
                update_info[component] = {
                    'current': current_version,
                    'latest': str(latest),
                    'available': [str(v) for v in VersionComparator.sort_versions(available, reverse=True)],
                    'update_available': update_available,
                    'update_type': update_type,
                    'breaking_change': VersionComparator.check_breaking_change(current_sem, latest) if update_available else False
                }
